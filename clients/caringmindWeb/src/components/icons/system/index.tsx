...
export const GrabIcon: React.FC<IconProps> = (props) => {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export const SettingsIcon = (props: React.FC<IconProps>) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
export function FlagIcon(props: React.FC<ClassnameIconProps>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"

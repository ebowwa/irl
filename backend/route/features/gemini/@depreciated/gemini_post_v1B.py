...
from services.geminiService import generate_content, generate_content_stream, configure_gemini
        ...
        if stream:
            ...
            async def stream_response():
                async for chunk in generate_content_stream(
                    ...
                    # Adjust the chunk data as needed
                    yield chunk
            ...
            if candidate_count == 1:
                # For a single candidate, return response.text or adjust accordingly
